...
%>	
			...
			<input type="hidden" name="num" value="<%=map.get("num") %>">
			<table align="center" width="600" border="1" cellspacing="0">
				...
				<tr>
					...
					<td colspan="3"><input type="text" name="sub" value="<%=map.get("sub") %>" size="55"></td>
				</tr>
				<tr>
					<td colspan="4" height="300"><textarea name="content" cols="60" rows="6"><%=map.get("content") %></textarea></td>
				</tr>
				<tr>
