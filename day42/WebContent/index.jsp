...
<jsp:include page="template/header.jsp">
	<jsp:param value="." name="path"/>
		...
		<h3>IT교육 산업 핵심 리더 더조은컴퓨터아카데미와<br>
대한민국 대표 온라인 고등 교육 메가스터디가 하나가 되었습니다!
</h3>
...
메가스터디는 최고의 고등 교육 컨텐츠를 제공하여 수많은 학생의 대학 진학에 힘쓰고 있습니다.
</p>
<p>더조은컴퓨터아카데미는 메가스터디와 만나 탄탄한 지식과 체계를 통해 더욱 안정적이고 퀄리티 있는 교육을 제공하여
수료생 여러분들의 취업과 자기발전을 위해 실무 중심의 커리큘럼에 집중하여 여러분들의 꿈을 이룰 수 있도록 최선을 다합니다.
</p>
